...
accessToken = "Bearer YTZiZjFkYjUtN2Q2My00NDY5LTkwYzctNGEzYjFkZWEyZjYzMjAzNGUyMjAtMTZl_P0A1_0ad74777-4693-4a9a-9221-0cc54ac673f5"  # ADD
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/kittipon") == 0: # Add
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openkey = "07c636b8945582a2f9b48f6582dd46de"
...
# 6. Provide the URL to the OpenWeather Geocoding address API.
        ...
        r = requests.get("http://api.openweathermap.org/geo/1.0/direct", # Add Get URL for OpenWeather Geocoding API
...
# 8. Prepare openweatherAPIGetParameters for OpenWeather API, https://openweathermap.org/api; current weather data for one location by geographic coordinates.
        ...
        openweatherAPIGetParameters = {
                                ...
                                "lon" : locationLng,
                                "appid" : openkey,
                            } # Add Paramiter for OpenWeather API

#######################################################################################
# 9. Provide the URL to the OpenWeather API; current weather data for one location.
        rw = requests.get("https://api.openweathermap.org/data/2.5/weather",  # Add URL for OpenWeather API
                             params = openweatherAPIGetParameters
                        )
        json_data_weather = rw.json()
        # print(json_data_weather) # Test
...
# 12. Complete the code to post the message to the Webex Teams room.         
        ...
        r = requests.post( "https://webexapis.com/v1/messages",  # Add
